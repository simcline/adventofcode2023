...
while exit_counter <=1e5:
    close_or_far = randint(0,1) #we bias the sampling toward close candidates because the function is locally continuous
    test_val = randint(0, upper_min-1)*close_or_far+randint(max(0, upper_min-100), upper_min-1)*(1-close_or_far)
